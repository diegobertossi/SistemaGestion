...
public class Resaltador implements TableCellRenderer {
	...
	public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus,
		...
		if (fila%2!=0 && isSelected == false){
			c.setBackground(Color.decode("#FF88FF"));
			c.setForeground(Color.BLACK);
		}
////		// Si la celda esta en la fila indicada y no esta seleccionada se
////		// coloreara de este modo
//		if (fila.compareTo(row) == 0 && isSelected == false) {
//			c.setBackground(Color.decode("#FF88FF"));
//			c.setForeground(Color.BLACK);}
////			// Si la celda esta en la fila indicada y esta seleccionada se
////			// coloreara de este modo
////		}
//		//
...
//		}
////		// Si la celda no esta en la fila indicada y esta seleccionada se
////		// coloreara de este modo
////
//		else if (fila.compareTo(row) != 0 && isSelected == true) {
//			c.setBackground(Color.BLUE);
