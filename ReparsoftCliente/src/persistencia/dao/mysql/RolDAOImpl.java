...
public class RolDAOImpl implements RolDAO
{
	...
	private static final String readall = "SELECT * FROM rol WHERE idRol !=1";
	...
	public boolean edit(RolDTO rol_a_editar)
	{
		...
		try 
		{			
			statement = conexion.getSQLConexion().prepareStatement("UPDATE rol SET idRol='"+rol_a_editar.getIdRol()+"' , "
					+"nombre = '"+rol_a_editar.getNombre()+"'"					
					+"WHERE idRol = "+rol_a_editar.getIdRol()+""
					);
