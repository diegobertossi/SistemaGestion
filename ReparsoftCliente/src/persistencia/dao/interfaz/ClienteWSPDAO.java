...
public interface ClienteWSPDAO 
{
	...
	public void ListarClientesWSP(@SuppressWarnings("rawtypes") JComboBox box);
	...
	public void ListarContactoxOrganizacion(@SuppressWarnings("rawtypes") JComboBox comboNombreBuscado, String organizacionWSP);
