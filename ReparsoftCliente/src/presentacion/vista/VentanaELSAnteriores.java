...
public class VentanaELSAnteriores extends JFrame {
    ...
    private void actualizarCampos() {
        ...
        // Asegúrate de actualizar también el área de texto para diagnóstico e informe cliente
        textDiagnostico.setText(r.getDiagnostico());
        // Si tienes un campo de informe cliente, actualízalo también
        textInformeCliente.setText(r.getInformeCliente());
        //actualizar el campo fecha de entrada
