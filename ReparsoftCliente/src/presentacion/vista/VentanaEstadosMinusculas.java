...
public class VentanaEstadosMinusculas extends JFrame 
{
	...
	public VentanaEstadosMinusculas(ControladorReparacion controlador) 
	{
		super();
		setResizable(false);
		...
		rdbtnRecambio = new JRadioButton("Sin Reparacion-Recambio Propuesto");
