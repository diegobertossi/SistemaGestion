...
public class VentanaEliminarRemito extends JFrame {
	...
	public VentanaEliminarRemito(ControladorSalidas controlador) {
		...
		btnAnular = new JButton("ANULAR REMITO");
		btnAnular.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
		btnAnular.setBackground(new Color(255, 99, 71));
		btnAnular.setFont(new Font("Cambria", Font.BOLD, 9));
		btnAnular.setBounds(182, 274, 123, 28);
		panel.add(btnAnular);
		...
		btnEliminar = new JButton("ELIMINAR REMITO");
		btnEliminar.setFont(new Font("Cambria", Font.BOLD, 9));
		btnEliminar.setBackground(new Color(255, 0, 0));
		btnEliminar.setBounds(336, 274, 123, 28);
		panel.add(btnEliminar);

		tblEquiposParaRemito.getTableHeader().setReorderingAllowed(false);

		int[] anchos = { 60, 200, 200, 150 };
	...
	public void setBtnAnular(JButton btnMarcarTodos) {
		this.btnAnular = btnMarcarTodos;
	}
