...
public class ControladorConfiguraciones implements ActionListener {
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		// ====================== BOTÓN EQUIPOS ANTIGUOS ======================
			...
			String nombreBaseAntigua = ubicacion.equalsIgnoreCase("Bariloche") 
					? "ordenesbrcantiguas" : "ordenesbsasantiguas";

			int opcion = JOptionPane.showConfirmDialog(vistaConfiguracion, 
					"¿Desea ver los equipos antiguos?\n\n",
		...
		// ====================== BOTÓN VOLVER A BASE NORMAL ======================
			...
			String ubicacion = obtenerUbicacionSegura();
			String nombreBaseNormal = ubicacion.equalsIgnoreCase("Bariloche") 
	...
	private String obtenerUbicacionSegura() {
		...
		if (ubicacion == null || ubicacion.trim().isEmpty()) {
			// Último recurso: intentar recuperar desde la vista principal (si ya tenía texto)
