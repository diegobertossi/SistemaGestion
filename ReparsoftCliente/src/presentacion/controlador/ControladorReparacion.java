...
<<<<<<< HEAD
			if (estadoTecnico == "En ReparaciÛn" || estadoTecnico == "Reparado"
					...
					|| estadoTecnico == "No Aceptaron ReparaciÛn") {
...
>>>>>>> refs/remotes/origin/master
			...
			if (ventanaEmail.getTextPara().getText().isEmpty()) {
				...
				JOptionPane.showMessageDialog(null, "Escriba un email correcto",
						"Error al registrar una direcciÛn de email", JOptionPane.ERROR_MESSAGE);
			} else
...
>>>>>>> refs/remotes/origin/master
			...
			int seleccion = JOptionPane.showConfirmDialog(ventanaVisualizarEquipos,
					"¬øDesea generar un N√∫mero De Serie?", "Confirmaci√≥n", JOptionPane.YES_NO_OPTION,
					JOptionPane.QUESTION_MESSAGE);
...
//	}
		...
		if (this.ventanaGenerarPresupuesto != null) {
			...
			if (this.ventanaGenerarPresupuesto.getGrupoMoneda()
				...
				ventanaGenerarPresupuesto.getTextcondicionesMoneda().setText(
						"Los precios estÔøΩn expresados en Pesos, son Netos y no incluyen el IVA (21%). La garantÔøΩa es de 90 dÔøΩas sobre la reparaciÔøΩn realizada");

			}

			else {
				ventanaGenerarPresupuesto.getTextcondicionesMoneda().setText(
						"Los precios estÔøΩn expresados en DÔøΩlares, son Netos y no incluyen el IVA (21%). La garantÔøΩa es de 90 dÔøΩas sobre la reparaciÔøΩn realizada");
	...
	private boolean verificacionDatosIngreso() {
		...
		if (idCli == 0) {
			...
			Object mje = "Debe asignar un Cliente a la reparaci√≥n ";
			...
			Object mje = "Fecha de entrada Incorrecta. Colocar una fecha V√°lida dd/mm/aaaa. Distinta de 00/00/0000";
			JOptionPane.showMessageDialog(null, mje, "Mensaje Informativo", JOptionPane.INFORMATION_MESSAGE); // Tipo
			...
			Object mje = "Fecha de fabricaci√≥n Incorrecta. Colocar una fecha V√°lida dd/mm/aaaa. Distinta de 00/00/0000";
			JOptionPane.showMessageDialog(null, mje, "Mensaje Informativo", JOptionPane.INFORMATION_MESSAGE); // Tipo
		...
		if (this.ventanaVisualizarEquipos != null) {
			...
			if (e.getSource() == this.ventanaVisualizarEquipos.getTablaRepuestos()) {
				if (e.getKeyCode() == KeyEvent.VK_ENTER) {
					...
					Object mje = "Deber√° 'GUARDAR EDICI√ìN' para mantener las modificaciones.";
					JOptionPane.showMessageDialog(null, mje, "Mensaje Informativo", JOptionPane.INFORMATION_MESSAGE);
	...
	public void itemStateChanged(ItemEvent e) {
		...
		if (ventanaRemitos != null && e.getSource() == ventanaRemitos.getComboUbicacion()
			...
			if (ventanaRemitos.getComboUbicacion().getSelectedIndex() == 1
				...
				ventanaRemitos.getTextTipoRemito().setText("REMITO COM√öN");
				ventanaRemitos.getTextTipoRemito().setVisible(true);
				ventanaRemitos.getPanel_2().setVisible(true);
