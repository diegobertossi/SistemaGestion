 ...
 * 
 * CAMBIOS ADICIONALES (20/04/2026):
 * - RadioButtons movidos por debajo de Usuario y Contraseña en el panel Destino.
 * - Eliminada la aclaración con flecha "→" y nombre de la BD en los textos de los RadioButtons.
 * - Reorganización de filas en GridBagLayout del panel Destino para evitar cualquier posible conflicto con WindowBuilder.
 * - Verificada toda la clase: NO existen componentes agregados más de una vez a un mismo contenedor.
 */
public class VentanaMigracion3 extends JDialog {
    ...
    // Nombres de las 4 BDs destino (se mantienen para uso interno en getDestinoBDSeleccionada)
    ...
    // ── Constructor ─────────────────────────────────────────────────────────
    public VentanaMigracion3(Frame padre) {
    ...
    private void initComponents() {
        ...
        rbBrcAct = new JRadioButton("Datos Bariloche Actuales");
        rbBasAct = new JRadioButton("Datos Buenos Aires Actuales");
    ...
    private JPanel crearPanelDestino() {
        ...
        JLabel lblDestBD    = new JLabel("Base de datos destino:");   // ← título movido y texto limpio
        ...
        GridBagConstraints dLU  = new GridBagConstraints(); dLU.insets=new Insets(2,4,2,4);  dLU.anchor=GridBagConstraints.WEST;  dLU.gridx=0;  dLU.gridy=2;  dLU.fill=GridBagConstraints.NONE;       dLU.weightx=0;
        GridBagConstraints dFU  = new GridBagConstraints(); dFU.insets=new Insets(2,4,2,4);  dFU.anchor=GridBagConstraints.WEST;  dFU.gridx=1;  dFU.gridy=2;  dFU.fill=GridBagConstraints.HORIZONTAL; dFU.weightx=1;
        GridBagConstraints dLPw = new GridBagConstraints(); dLPw.insets=new Insets(2,4,2,4); dLPw.anchor=GridBagConstraints.WEST; dLPw.gridx=0; dLPw.gridy=3; dLPw.fill=GridBagConstraints.NONE;       dLPw.weightx=0;
        GridBagConstraints dFPw = new GridBagConstraints(); dFPw.insets=new Insets(2,4,2,4); dFPw.anchor=GridBagConstraints.WEST; dFPw.gridx=1; dFPw.gridy=3; dFPw.fill=GridBagConstraints.HORIZONTAL; dFPw.weightx=1;

        // Constraints para la sección de RadioButtons (ahora debajo de Usuario/Contraseña)
        GridBagConstraints dLB  = new GridBagConstraints(); dLB.insets=new Insets(2,4,2,4);  dLB.anchor=GridBagConstraints.WEST;  dLB.gridx=0;  dLB.gridy=4;  dLB.fill=GridBagConstraints.NONE;       dLB.weightx=0;
        GridBagConstraints dFB  = new GridBagConstraints(); dFB.insets=new Insets(2,4,2,4);  dFB.anchor=GridBagConstraints.WEST;  dFB.gridx=1;  dFB.gridy=4;  dFB.fill=GridBagConstraints.HORIZONTAL; dFB.weightx=1;
        GridBagConstraints dLB2 = new GridBagConstraints(); dLB2.insets=new Insets(2,4,2,4); dLB2.anchor=GridBagConstraints.WEST; dLB2.gridx=0; dLB2.gridy=5; dLB2.fill=GridBagConstraints.NONE;       dLB2.weightx=0;
        GridBagConstraints dFB2 = new GridBagConstraints(); dFB2.insets=new Insets(2,4,2,4); dFB2.anchor=GridBagConstraints.WEST; dFB2.gridx=1; dFB2.gridy=5; dFB2.fill=GridBagConstraints.HORIZONTAL; dFB2.weightx=1;
        GridBagConstraints dLB3 = new GridBagConstraints(); dLB3.insets=new Insets(2,4,2,4); dLB3.anchor=GridBagConstraints.WEST; dLB3.gridx=0; dLB3.gridy=6; dLB3.fill=GridBagConstraints.NONE;       dLB3.weightx=0;
        GridBagConstraints dFB3 = new GridBagConstraints(); dFB3.insets=new Insets(2,4,2,4); dFB3.anchor=GridBagConstraints.WEST; dFB3.gridx=1; dFB3.gridy=6; dFB3.fill=GridBagConstraints.HORIZONTAL; dFB3.weightx=1;
        GridBagConstraints dLB4 = new GridBagConstraints(); dLB4.insets=new Insets(2,4,2,4); dLB4.anchor=GridBagConstraints.WEST; dLB4.gridx=0; dLB4.gridy=7; dLB4.fill=GridBagConstraints.NONE;       dLB4.weightx=0;
        GridBagConstraints dFB4 = new GridBagConstraints(); dFB4.insets=new Insets(2,4,2,4); dFB4.anchor=GridBagConstraints.WEST; dFB4.gridx=1; dFB4.gridy=7; dFB4.fill=GridBagConstraints.HORIZONTAL; dFB4.weightx=1;

        // Agregado en orden lógico de filas (host → port → user → pass → radios)
